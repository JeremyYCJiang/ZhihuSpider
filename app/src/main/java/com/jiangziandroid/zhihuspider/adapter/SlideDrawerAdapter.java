...
public class SlideDrawerAdapter extends RecyclerView.Adapter<SlideDrawerAdapter.ViewHolder> {
    ...
    public SlideDrawerAdapter(String Titles[],int Icons[],String Name,String Email, int Profile){ // MyAdapter Constructor with titles and icons parameter
